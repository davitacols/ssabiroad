  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 flex gap-12">
        ...
        {/* Title */}
        <h1 className="text-[42px] leading-[52px] font-bold tracking-tight mb-2">{post.title}</h1>
        ...
        <div className="flex items-center gap-3 mb-8 pb-6 border-b border-stone-200 dark:border-stone-800">
          <span className="text-sm text-stone-600 dark:text-stone-400">Share:</span>
          <a
            href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(post.title)}&url=${encodeURIComponent(window.location.href)}`}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-black text-white hover:bg-stone-800 transition-colors text-sm"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#1877F2] text-white hover:bg-[#166FE5] transition-colors text-sm"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#0A66C2] text-white hover:bg-[#004182] transition-colors text-sm"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#25D366] text-white hover:bg-[#1DA851] transition-colors text-sm"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-stone-200 dark:bg-stone-800 text-stone-900 dark:text-stone-100 hover:bg-stone-300 dark:hover:bg-stone-700 transition-colors text-sm"
          >
