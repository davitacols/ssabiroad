...
const isStale = (cached) => {
  ...
  return Date.now() - new Date(cached.updatedAt).getTime() > CACHE_TTL;
};
...
export const getLocation = async (query) => {
  ...
  // Cascade order based on optimal provider
