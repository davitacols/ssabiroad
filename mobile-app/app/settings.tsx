...
const styles = StyleSheet.create({
  ...
  backText: { fontSize: 16, color: '#3b82f6', fontWeight: '600', marginBottom: 16 },
  title: { fontSize: 32, fontWeight: '800', color: '#0f172a' },
  content: { flex: 1 },
  section: { marginTop: 24, backgroundColor: '#fff', paddingHorizontal: 20 },
  sectionTitle: { fontSize: 13, fontWeight: '700', color: '#64748b', textTransform: 'uppercase', paddingVertical: 12 },
