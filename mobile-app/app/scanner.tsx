...
const styles = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 22, fontFamily: 'LeagueSpartan_700Bold', color: '#000', marginBottom: 8, fontFamily: 'LeagueSpartan_700Bold' },
  ...
  primaryActionText: { color: '#fff', fontSize: 16, fontFamily: 'LeagueSpartan_700Bold', fontFamily: 'LeagueSpartan_700Bold' },
  ...
  secondaryActionText: { color: '#000', fontSize: 16, fontFamily: 'LeagueSpartan_600SemiBold', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  loadingText: { fontSize: 15, color: '#000', fontFamily: 'LeagueSpartan_600SemiBold', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  errorTitle: { fontSize: 20, fontFamily: 'LeagueSpartan_700Bold', color: '#dc2626', marginBottom: 12, fontFamily: 'LeagueSpartan_700Bold', textAlign: 'center' },
  ...
  errorTipsTitle: { fontSize: 14, fontFamily: 'LeagueSpartan_700Bold', color: '#dc2626', marginBottom: 12, fontFamily: 'LeagueSpartan_700Bold' },
  ...
  locationInfo: { flex: 1 },
  locationName: { fontSize: 20, fontFamily: 'LeagueSpartan_700Bold', color: '#000', marginBottom: 6, fontFamily: 'LeagueSpartan_700Bold' },
  ...
  confidenceLabel: { fontSize: 13, fontFamily: 'LeagueSpartan_600SemiBold', color: '#6b7280', fontFamily: 'LeagueSpartan_600SemiBold' },
  confidenceValue: { fontSize: 16, fontFamily: 'LeagueSpartan_700Bold', color: '#000000', fontFamily: 'LeagueSpartan_700Bold' },
  ...
  cardTitle: { fontSize: 14, fontFamily: 'LeagueSpartan_700Bold', color: '#6b7280', marginBottom: 12, textTransform: 'uppercase', letterSpacing: 0.5, fontFamily: 'LeagueSpartan_700Bold' },
  ...
  coordinatesText: { fontSize: 15, fontFamily: 'LeagueSpartan_600SemiBold', color: '#000000', fontFamily: 'LeagueSpartan_600SemiBold' },
  dataValue: { fontSize: 16, fontFamily: 'LeagueSpartan_600SemiBold', color: '#000000', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  infoValue: { fontSize: 15, fontFamily: 'LeagueSpartan_600SemiBold', color: '#000000', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  detailValue: { fontSize: 14, fontFamily: 'LeagueSpartan_600SemiBold', color: '#000000', flex: 1, textAlign: 'right', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  nearbyBadgeText: { color: '#ffffff', fontSize: 12, fontFamily: 'LeagueSpartan_600SemiBold', fontFamily: 'LeagueSpartan_600SemiBold' },
  nearbyScroll: { },
  nearbyCard: { width: 140, backgroundColor: '#f9fafb', borderRadius: 12, padding: 16, marginRight: 12 },
  nearbyName: { fontSize: 14, fontFamily: 'LeagueSpartan_600SemiBold', color: '#000000', marginBottom: 4, height: 36, fontFamily: 'LeagueSpartan_600SemiBold' },
  nearbyType: { fontSize: 12, color: '#6b7280', marginBottom: 8, textTransform: 'capitalize', fontFamily: 'LeagueSpartan_400Regular' },
  nearbyDistance: { fontSize: 12, color: '#000000', fontFamily: 'LeagueSpartan_600SemiBold', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  ratingValue: { fontSize: 24, fontFamily: 'LeagueSpartan_700Bold', color: '#000', fontFamily: 'LeagueSpartan_700Bold' },
  ...
  hoursStatus: { fontSize: 15, fontFamily: 'LeagueSpartan_600SemiBold', color: '#10b981', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  reviewAuthor: { fontSize: 14, fontFamily: 'LeagueSpartan_600SemiBold', color: '#000', fontFamily: 'LeagueSpartan_600SemiBold' },
  reviewRating: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  reviewRatingText: { fontSize: 13, fontFamily: 'LeagueSpartan_600SemiBold', color: '#000', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  currentTemp: { fontSize: 48, fontFamily: 'LeagueSpartan_700Bold', color: '#000', fontFamily: 'LeagueSpartan_700Bold' },
  ...
  forecastDate: { fontSize: 11, fontFamily: 'LeagueSpartan_600SemiBold', color: '#6b7280', marginBottom: 8, fontFamily: 'LeagueSpartan_600SemiBold' },
  forecastTemp: { fontSize: 18, fontFamily: 'LeagueSpartan_700Bold', color: '#000', marginBottom: 4, fontFamily: 'LeagueSpartan_700Bold' },
  ...
  actionText: { fontSize: 12, fontFamily: 'LeagueSpartan_600SemiBold', color: '#000000', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  shareOptionText: { fontSize: 11, fontFamily: 'LeagueSpartan_600SemiBold', color: '#000', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  notesButtonText: { color: '#ffffff', fontSize: 15, fontFamily: 'LeagueSpartan_600SemiBold', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  addCollectionText: { color: '#ffffff', fontSize: 15, fontFamily: 'LeagueSpartan_600SemiBold', fontFamily: 'LeagueSpartan_600SemiBold' },
  streetViewButton: { backgroundColor: '#000', borderRadius: 12, padding: 18, alignItems: 'center', marginTop: 8 },
  streetViewText: { color: '#ffffff', fontSize: 15, fontFamily: 'LeagueSpartan_600SemiBold', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  modalTitle: { fontSize: 20, fontFamily: 'LeagueSpartan_700Bold', color: '#000', fontFamily: 'LeagueSpartan_700Bold' },
  modalEmpty: { paddingVertical: 40, alignItems: 'center' },
  modalEmptyText: { fontSize: 16, fontFamily: 'LeagueSpartan_600SemiBold', color: '#6b7280', marginBottom: 4, fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  collectionItemName: { fontSize: 15, fontFamily: 'LeagueSpartan_600SemiBold', color: '#000', marginBottom: 2, fontFamily: 'LeagueSpartan_600SemiBold' },
  collectionItemCount: { fontSize: 13, color: '#6b7280', fontFamily: 'LeagueSpartan_400Regular' },
  notesInputGroup: { marginBottom: 20 },
  notesLabel: { fontSize: 13, fontFamily: 'LeagueSpartan_600SemiBold', color: '#6b7280', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5, fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  saveNotesButtonText: { color: '#fff', fontSize: 16, fontFamily: 'LeagueSpartan_600SemiBold', fontFamily: 'LeagueSpartan_600SemiBold' },
  camera: { flex: 1 },
  cameraContainer: { flex: 1 },
  cameraHeader: { paddingHorizontal: 24, paddingTop: 60, paddingBottom: 20 },
  cameraClose: { alignSelf: 'flex-start' },
  cameraCloseText: { color: '#ffffff', fontSize: 16, fontFamily: 'LeagueSpartan_600SemiBold', fontFamily: 'LeagueSpartan_600SemiBold' },
