...
const styles = StyleSheet.create({
  ...
  badgeText: { color: '#fff', fontSize: 12, fontWeight: '700', fontFamily: 'LeagueSpartan_700Bold' },
  content: { flex: 1 },
  infoCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#eef2ff', margin: 20, padding: 16, borderRadius: 12, gap: 12 },
  infoText: { fontSize: 14, color: '#4338ca', fontWeight: '600', fontFamily: 'LeagueSpartan_600SemiBold' },
  locationsSection: { paddingHorizontal: 20, paddingBottom: 100 },
  sectionTitle: { fontSize: 12, fontWeight: '700', color: '#6b7280', marginBottom: 16, letterSpacing: 1.5, fontFamily: 'LeagueSpartan_700Bold' },
  emptyState: { alignItems: 'center', paddingVertical: 40 },
  emptyText: { fontSize: 16, fontWeight: '600', color: '#6b7280', marginTop: 16, fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  locationInfo: { flex: 1 },
  locationName: { fontSize: 16, fontWeight: '700', color: '#000', marginBottom: 4, fontFamily: 'LeagueSpartan_700Bold' },
  ...
  compareButtonText: { color: '#fff', fontSize: 16, fontWeight: '700', fontFamily: 'LeagueSpartan_700Bold' },
  ...
  resetButtonText: { color: '#6366f1', fontSize: 15, fontWeight: '700', fontFamily: 'LeagueSpartan_700Bold' },
  ...
  comparisonName: { fontSize: 18, fontWeight: '700', color: '#000', marginBottom: 4, fontFamily: 'LeagueSpartan_700Bold' },
  ...
  comparisonValue: { fontSize: 24, fontWeight: '700', color: '#000', fontFamily: 'LeagueSpartan_700Bold' },
  ...
  summaryTitle: { fontSize: 16, fontWeight: '700', color: '#000', marginBottom: 16, fontFamily: 'LeagueSpartan_700Bold' },
  ...
  summaryValue: { fontSize: 14, fontWeight: '600', color: '#000', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  loadingText: { color: '#fff', fontSize: 16, fontWeight: '600', marginTop: 12, fontFamily: 'LeagueSpartan_600SemiBold' },
});
