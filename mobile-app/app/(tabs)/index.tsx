...
const styles = StyleSheet.create({
  ...
  secondaryButtonText: { color: '#1c1917', fontSize: 17, fontWeight: '700' },
  ...
  loadingText: { marginTop: 16, fontSize: 16, color: '#78716c', fontWeight: '600' },
  ...
  resultLabel: { fontSize: 11, color: '#78716c', fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
  resultValue: { fontSize: 16, color: '#1c1917', lineHeight: 24, fontWeight: '500' },
  badge: { marginTop: 20, backgroundColor: '#dcfce7', paddingVertical: 10, paddingHorizontal: 18, borderRadius: 9999, alignSelf: 'flex-start' },
  badgeText: { color: '#166534', fontSize: 14, fontWeight: '700' },
