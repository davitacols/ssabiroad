...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 28, fontFamily: 'LeagueSpartan_700Bold', color: '#000' },
  ...
  filterText: { fontSize: 14, fontFamily: 'LeagueSpartan_600SemiBold', color: '#6b7280' },
  filterTextActive: { color: '#fff' },
  content: { flex: 1, paddingHorizontal: 20 },
  dateGroup: { marginTop: 20 },
  dateHeader: { fontSize: 13, fontFamily: 'LeagueSpartan_700Bold', color: '#6b7280', marginBottom: 12, textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  cardTitle: { fontSize: 15, fontFamily: 'LeagueSpartan_600SemiBold', color: '#000', marginBottom: 2 },
  cardAddress: { fontSize: 13, color: '#6b7280', marginBottom: 4 },
  cardTime: { fontSize: 11, color: '#9ca3af', fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  mapText: { fontSize: 16, fontFamily: 'LeagueSpartan_600SemiBold', color: '#374151', marginTop: 20 },
