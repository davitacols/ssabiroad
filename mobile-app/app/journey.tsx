...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 28, fontWeight: '700', color: '#fff', flex: 1, fontFamily: 'LeagueSpartan_700Bold' },
  clearButton: { padding: 4 },
  heroSection: { paddingHorizontal: 20, paddingBottom: 24, backgroundColor: '#000' },
  heroTitle: { fontSize: 32, fontWeight: '700', color: '#fff', marginBottom: 8, fontFamily: 'LeagueSpartan_700Bold' },
  ...
  statNumber: { fontSize: 28, fontWeight: '700', color: '#000', marginBottom: 4, fontFamily: 'LeagueSpartan_700Bold' },
  ...
  sectionHeader: { fontSize: 13, fontWeight: '700', color: '#6b7280', marginBottom: 16, letterSpacing: 1, fontFamily: 'LeagueSpartan_700Bold' },
  ...
  locationInfo: { flex: 1 },
  locationName: { fontSize: 16, fontWeight: '600', color: '#000', marginBottom: 4, fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  emptyTitle: { fontSize: 20, fontWeight: '700', color: '#000', marginTop: 16, marginBottom: 8, fontFamily: 'LeagueSpartan_700Bold' },
  ...
  modalTitle: { fontSize: 20, fontWeight: '700', color: '#000', marginBottom: 12, fontFamily: 'LeagueSpartan_700Bold' },
  ...
  cancelText: { fontSize: 15, fontWeight: '600', color: '#000', fontFamily: 'LeagueSpartan_600SemiBold' },
  deleteButton: { flex: 1, backgroundColor: '#ef4444', borderRadius: 12, padding: 16, alignItems: 'center' },
  deleteText: { fontSize: 15, fontWeight: '600', color: '#fff', fontFamily: 'LeagueSpartan_600SemiBold' },
});
