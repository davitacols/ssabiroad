...
const styles = StyleSheet.create({
  ...
  backIcon: { fontSize: 16, color: '#374151', fontFamily: 'LeagueSpartan_600SemiBold' },
  title: { flex: 1, textAlign: 'center', fontSize: 20, fontFamily: 'LeagueSpartan_700Bold', color: '#111827' },
  ...
  actionText: { color: '#fff', fontSize: 16, fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  analyzeText: { color: '#fff', fontSize: 16, fontFamily: 'LeagueSpartan_600SemiBold' },
  resultsContainer: { marginBottom: 24 },
  resultsTitle: { fontSize: 22, fontFamily: 'LeagueSpartan_700Bold', color: '#111827', marginBottom: 20 },
  ...
  tagTitle: { flex: 1, fontSize: 18, fontFamily: 'LeagueSpartan_600SemiBold', color: '#374151' },
  tagCount: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12 },
  tagCountText: { color: '#fff', fontSize: 12, fontFamily: 'LeagueSpartan_600SemiBold' },
  ...
  tagText: { fontSize: 14, fontFamily: 'LeagueSpartan_600SemiBold' },
  confidence: { fontSize: 12, color: '#6B7280', fontFamily: 'LeagueSpartan_600SemiBold' },
  emptyState: { alignItems: 'center', paddingVertical: 60 },

  emptyTitle: { fontSize: 24, fontFamily: 'LeagueSpartan_700Bold', color: '#111827', marginBottom: 8 },
