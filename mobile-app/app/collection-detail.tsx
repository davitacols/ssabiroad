...
const styles = StyleSheet.create({
  ...
  tagText: { fontSize: 12, fontWeight: '600', color: '#fff', textTransform: 'uppercase' },
  locationCount: { fontSize: 15, fontWeight: '600', color: '#6b7280' },
  content: { flex: 1 },
  ...
  locationName: { fontSize: 16, fontWeight: '600', color: '#000', marginBottom: 4 },
  ...
  modalNotesLabel: { fontSize: 12, fontWeight: '600', color: '#6b7280', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
