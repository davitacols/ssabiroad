...
export const PlacesAutocomplete = ({ placeholder, className, onPlaceSelect }: PlacesAutocompleteProps) => {
  ...
  return (
    <div className="relative w-full" ref={autoCompleteRef}>
      ...
      {showPredictions && predictions.length > 0 && (
        <div className="absolute z-50 mt-1 w-full bg-background/95 backdrop-blur-sm border border-border rounded-md shadow-lg max-h-60 overflow-auto">
          {apiError === "billing_not_enabled" && (
